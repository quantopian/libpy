...
inline py::scoped_ref<> nested_getattr(py::borrowed_ref<> ob) {
    return py::scoped_ref<>::new_reference(ob);
}
...
py::scoped_ref<> nested_getattr(py::borrowed_ref<> ob, const T& head, const Ts&... tail) {
